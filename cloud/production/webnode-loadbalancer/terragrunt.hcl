terraform {
  source = "git::git@github.com:terraform-aws-modules/terraform-aws-alb.git?ref=v5.13.0"
}
...
# https://registry.terraform.io/modules/terraform-aws-modules/alb/aws/5.13.0?tab=inputs
###########################################################
inputs = {
  ...
  # type: list(string)
  security_groups = [dependency.loadbalancer-internal-securitygroup.outputs.this_security_group_id]
